...
public class FriendsGUI extends CustomGui {
    ...
    public FriendsGUI(Player p, int page) {
        ...
        for (UUID uuid : friends) {
            ...
            setItem(slots[i], CustomItemStack.getPlayerSkull(name).setName(EndoSkullAPI.getPrefix(uuid) + name + " " + (online ? "§a(" + MessageUtils.Paf.ONLINE +")" : "§c(" + MessageUtils.Paf.OFFLINE + ")")));
            i++;
