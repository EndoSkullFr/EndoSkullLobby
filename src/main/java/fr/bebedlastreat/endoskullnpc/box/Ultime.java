...
public enum Ultime {
    HERO("§bGrade Hero §7(1 mois)", 2, "lp user %player% parent addtemp hero 1mo accumulate", new ItemStack(Material.DIAMOND)),
    VIP("§eGrade VIP §7(1 mois)", 6, "lp user %player% parent addtemp vip 1mo accumulate", new ItemStack(Material.GOLD_INGOT)),
